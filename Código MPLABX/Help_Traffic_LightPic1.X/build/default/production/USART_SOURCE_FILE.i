...
# 29 "./USART_Header_File.h" 2

void USART_Init(long);
void USART_TxChar(char);
void USART_SendString(const char *);
char USART_RxChar();
# 23 "USART_SOURCE_FILE.c" 2
# 37 "USART_SOURCE_FILE.c"
