...
# 105 "./LCD_16x2_Library.h"
void lcd_clear()
{
   Lcd_Cmd(0);
   Lcd_Cmd(1);
}
# 124 "./LCD_16x2_Library.h"
...
# 235 "./LCD_16x2_Library.h"
void lcd_shift_right()
{
   Lcd_Cmd(0x01);
   Lcd_Cmd(0x0C);
}
# 253 "./LCD_16x2_Library.h"
void lcd_shift_left()
{
   Lcd_Cmd(0x01);
   Lcd_Cmd(0x08);
...
void controlSemaforo(void){
    ...
    _delay((unsigned long)((7)*(8000000/4000.0)));
...
void funcion_SensorPir(int bandera){
    ...
    if(PORTAbits.RA2 == 1 && PORTDbits.RD2 == 1){
        LATD3 = 1;
